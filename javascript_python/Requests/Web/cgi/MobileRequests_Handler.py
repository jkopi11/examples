...
try:
    ...
    def getRequesterParameters(p):
        ...
        rData['outFields'] = '*'
        rIDs = json.loads(dghttpclient.getHttpRequestESRI(rUrl,rData))['features']
    ...
    def getRequestData(params):
        ...
        result = json.loads(dghttpclient.getHttpRequestESRI(url,data))['features']
    ...
    def parseData(requests):
        ...
        if len(requests) > 0:
            for r in requests:
                r = r['attributes']
                requestDict = {'RequestID':r['RequestID'],'RequestType':r['RequestTypeText'],'Description':r['Description'],'StatusDate':r['StatusDate'],'SubmittedDate':r['SubmittedDate'],'StatusText':r['StatusText']}
